...
Something went wrong with the file you tried to open or load. Make sure the file name, if given manually, has the extension as well as the name. 
"""

configure_FPGA_error_text = """
Could not configure FPGA. 
"""

connect_to_device_error_text = """
